...
namespace ProyectoParcial2.Controllers
{
    public class DiseasesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DiseaseName,DiseaseDescription")] Disease disease)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DiseaseName,DiseaseDescription")] Disease disease)
        {
            if (id != disease.Id)
            {
                return NotFound();
